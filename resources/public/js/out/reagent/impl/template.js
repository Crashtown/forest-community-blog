...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27042__auto__,writer__27043__auto__,opt__27044__auto__){
return cljs.core._write.call(null,writer__27043__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__27962 = o;
(G__27962[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__27963__delegate = function (args){
...
while (G__27964__i < G__27964__a.length) {G__27964__a[G__27964__i] = arguments[G__27964__i + 0]; ++G__27964__i;}
  args = new cljs.core.IndexedSeq(G__27964__a,0,null);
} 
...
var args = cljs.core.seq(arglist__27965);
...
if(cljs.core.truth_((function (){var and__26419__auto__ = !((jsprops == null));
if(and__26419__auto__){
var and__26419__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__27970 = jsprops;
(G__27970["defaultValue"] = value);

(G__27970["onChange"] = ((function (G__27970,v,value,on_change){
return (function (p1__27968_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27968_SHARP_);
});})(G__27970,v,value,on_change))
);
...
var vec__27977 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27977,(0),null);
var id = cljs.core.nth.call(null,vec__27977,(1),null);
var class$ = cljs.core.nth.call(null,vec__27977,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___27982 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___27982 == null)){
} else {
var key_27983 = temp__4661__auto___27982;
(jsprops["key"] = key_27983);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__27985 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__27985["name"] = c);
...
var len__27544__auto___27991 = arguments.length;
var i__27545__auto___27992 = (0);
while(true){
if((i__27545__auto___27992 < len__27544__auto___27991)){
args__27551__auto__.push((arguments[i__27545__auto___27992]));

var G__27993 = (i__27545__auto___27992 + (1));
i__27545__auto___27992 = G__27993;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27552__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27989){
var G__27990 = cljs.core.first.call(null,seq27989);
var seq27989__$1 = cljs.core.next.call(null,seq27989);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__27990,seq27989__$1);
});
...
break;
default:
var G__27997 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__27997;
continue;
...
var n__27354__auto___28000 = a.length;
var i_28001 = (0);
while(true){
if((i_28001 < n__27354__auto___28000)){
(a[i_28001] = reagent.impl.template.as_element.call(null,(a[i_28001])));

var G__28002 = (i_28001 + (1));
i_28001 = G__28002;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__27354__auto___28003 = a.length;
var i_28004 = (0);
while(true){
if((i_28004 < n__27354__auto___28003)){
var val_28005 = (a[i_28004]);
if((cljs.core.vector_QMARK_.call(null,val_28005)) && ((reagent.impl.template.key_from_vec.call(null,val_28005) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28004] = reagent.impl.template.as_element.call(null,val_28005));

var G__28006 = (i_28004 + (1));
i_28004 = G__28006;
continue;
} else {
}
...
var ctx = ({});
var vec__28010 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28010,(0),null);
var derefed = cljs.core.nth.call(null,vec__28010,(1),null);
...
var G__28014 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28014) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__28014){
...
//# sourceMappingURL=template.js.map?rel=1498425864986